...
const PopularProducts = () => {
    ...
    const featureProduct = products.slice(5, 9)
    const dispatch = useDispatch()
    // const globalState = useSelector(state=>state.FavProduct.isClicked)
    ...
    return (
        <div className=' my-5' style={{padding:"0 30px"}}>
            <h3 className='text-black text-left fw-bold my-4'>Our Popular Products</h3>
            <div className='row'>

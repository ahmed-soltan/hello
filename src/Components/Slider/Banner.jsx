            ...
            <div className='row'>
                <div className='col-lg-6 col-sm-12 mb-2 rounded-5 position-relative'style={{overflow:"hidden"}} >
                    <Swiper
                        ...
                        className="mySwiper"
                    >
                        <SwiperSlide style={{minHeight:"320px"}}>
                            <img src={banner1} className='w-100 ' style={{minHeight:"320px"}} loading="lazy" />
                            <div className='text'>
                        ...
                        <SwiperSlide style={{minHeight:"320px"}}>
                            <img src={banner2} className='w-100 ' style={{minHeight:"320px"}} loading="lazy" />
                            <div className='text'>
                                <p className='text-danger fw-bold'>SUPERCHARGED FOR PROS</p>

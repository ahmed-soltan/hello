...
const Advertisement = () => {
  return (
    <div
      className="d-flex align-items-lg-start justify-content-lg-start flex-column "
      style={{ padding: "30px " }}
    >
      <h3 className="text-black fw-bold w-100">Best Sales</h3>
      <div className="row gap-3 adContainer">
        <div className="bg-black text-white p-2" style={{ width: "390px" }}>
        ...
        <div className="bg-white p-2" style={{ width: "390px" }}>

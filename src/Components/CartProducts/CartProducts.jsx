  ...
  return (
    <div className="my-5 table-responsive">
      {cartProducts.length !== 0 ? (
                    ...
                    <td>
                      <i
                        ...
                        onClick={() =>
                          ...
                          toast.error(
                            <span className="fs-6">
                              {product.title} is removed to the cart
                            </span>
                          )
                        }
                      ></i>
        ...
        <NavLink to="/products" className="btn btn-black me-2">
            Continue Shopping
          </NavLink>
          <button
            className="btn btn-danger"
            style={{ backgroundColor: "rgb(158, 40, 40) !important" }}
        ...
        <div>
          ...
          <NavLink to="/products" className="btn btn-black mt-3 ">
            Go Shopping
          </NavLink>
        </div>
      )}
